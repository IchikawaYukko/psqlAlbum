...
<?php require_once('description.php'); ?>
	...
	<div class="fb-like" data-href="<?php print $psqlAlbum['AlbumRoot']; ?>" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true"></div>
	<a href="http://b.hatena.ne.jp/entry/<?php print $psqlAlbum['AlbumRoot']; ?>" class="hatena-bookmark-button" data-hatena-bookmark-title="<?php print $psqlAlbum['AlbumName']; ?>" data-hatena-bookmark-layout="standard-balloon" data-hatena-bookmark-lang="ja" title="このエントリーをはてなブックマークに追加"><img src="https://b.st-hatena.com/images/entry-button/button-only@2x.png" alt="このエントリーをはてなブックマークに追加" width="20" height="20" style="border: none;"></a><script type="text/javascript" src="https://b.st-hatena.com/js/bookmark_button.js" charset="utf-8" async="async"></script>
